    ...
    >
      ...
      >
        <motion.div
          ...
          viewport={{ once: true }}
          className="mx-auto mb-10 flex w-full max-w-2xl flex-col items-center text-center sm:mb-12"
          style={{ width: "100%", maxWidth: "42rem", marginInline: "auto", textAlign: "center" }}
        >
        ...
        >
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="grid w-full items-stretch gap-4 md:grid-cols-3 md:gap-5"
          >
